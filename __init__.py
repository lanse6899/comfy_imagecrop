...
try:
    ...
    from .canvas_extend_node import CanvasExtendNode
    from .simple_annotation_node import SimpleAnnotationNode
    from .easybrush_node import EasyBrushNode
